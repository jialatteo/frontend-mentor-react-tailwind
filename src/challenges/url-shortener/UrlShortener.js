...
export default function UrlShortener() {
  ...
  return (
    <div className="font-poppins mx-auto max-w-[1440px]">
      ...
      <div className="my-16 ml-32 flex flex-col-reverse items-center justify-between sm:flex-row">
      ...
      <div className="flex flex-col justify-between bg-url-shortener-very-dark-violet px-32 py-16 align-top sm:flex-row">
        {/* prettier-ignore */}
