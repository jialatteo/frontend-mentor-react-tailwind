    ...
    >
      ...
      >
        ...
        <div className="relative mx-6 my-20 mb-40 flex flex-col gap-6 sm:flex-row">
          <div className="absolute left-0 right-0 top-1/2 hidden h-2 bg-url-shortener-cyan sm:block"></div>
          <div className="absolute bottom-0 left-1/2 top-0 w-2 bg-url-shortener-cyan"></div>
          <div className="relative bottom-10 max-w-80 bg-white p-8">
            <div className="absolute -top-10 left-[124px] flex h-20 w-20 items-center justify-center rounded-full bg-url-shortener-very-dark-blue sm:left-0">
              {/* prettier-ignore */}
            ...
            <p className="mb-6 mt-10 text-center text-xl font-bold sm:text-start">
              Brand Recognition
            </p>
