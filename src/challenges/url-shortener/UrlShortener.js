...
export default function UrlShortener() {
  return (
    <div className="font-poppins mx-auto max-w-[1440px]">
      ...
      <div className="mt-32 flex flex-col items-center bg-[#F0F1F6]">
        ...
        <div className="relative my-20 mb-40 flex gap-6">
      ...
      <div className="flex justify-between bg-url-shortener-very-dark-violet px-32 py-16 align-top">
        {/* prettier-ignore */}
