...
export default function UrlShortener() {
  ...
  return (
    <div className="font-poppins max-w-[1440px] sm:mx-auto">
      <div className="flex w-full justify-between px-6 py-10 text-lg lg:px-32">
      ...
      >
        ...
        <p className="my-4 mt-10 text-2xl font-bold sm:text-4xl">
          Advanced Statistics
        </p>
        ...
        <div className="relative mx-6 my-20 mb-40 flex flex-col gap-6 sm:flex-row">
      ...
      <div className="flex flex-col items-center justify-between gap-8 bg-url-shortener-very-dark-violet px-6 py-16 align-top sm:flex-row sm:items-start sm:gap-0 lg:px-32">
        {/* prettier-ignore */}
