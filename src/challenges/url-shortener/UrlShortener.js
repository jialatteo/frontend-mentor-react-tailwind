...
export default function UrlShortener() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setShortenedLinks((prevLinkList) => [
        { original: inputLink, shortened: shortenedLink, copied: false },
        ...prevLinkList,
      ]);
    } catch (error) {
      setError("inputLink", {
  ...
  const handleCopy = (copiedLink) => {
    setShortenedLinks((prevLinkList) =>
      prevLinkList.map((link) =>
        link === copiedLink
          ? { ...link, copied: true }
          : { ...link, copied: false },
      ),
    );
    navigator.clipboard.writeText(copiedLink.shortened).catch(() => {
      ...
      >
        <div className="absolute -top-20 h-36 w-[calc(100%-16rem)] rounded-lg bg-[#3A3053]">
          ...
          >
            ...
            <button className="mr-12 flex w-48 items-center justify-center rounded-lg bg-url-shortener-cyan px-6 py-[15px] text-lg font-semibold text-white hover:bg-[#99E3E2] hover:text-opacity-95">
              {isLoading ? (
                // prettier-ignore
        ...
        {shortenedLinks.map((link) => (
          <div className="mb-3 flex w-[calc(100%-16rem)] items-center justify-between rounded-lg bg-white p-4 pl-8">
            <div className="flex w-full justify-between">
              <p className="text-xl font-medium">{link.original}</p>
            ...
            <button
              ...
              className={`ml-4 w-28 rounded-md ${link.copied ? "bg-url-shortener-very-dark-blue" : "bg-url-shortener-cyan hover:bg-[#99E3E2]"} py-2 font-semibold text-white`}
            >
