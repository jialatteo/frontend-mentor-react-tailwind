  ...
  return (
    <div className={`${KumbhSans.className} relative`}>
      ...
      <div className="p-4 pb-14">
        ...
        <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-ecommerce-product-page-orange p-4 shadow-xl shadow-ecommerce-product-page-orange/20 hover:bg-opacity-40">
          {/* prettier-ignore */}
