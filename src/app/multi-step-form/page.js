...
const validationSchemas = [
  ...
  Yup.object({
    ...
    billing: Yup.string()
      .oneOf(["monthly", "yearly"], "Please select a billing cycle")
            ...
            <div>
                ...
                <label className="flex" htmlFor="arcade">
                  ...
                  <div className="peer-checked:bg-multi-step-form-alabaster hover:border-multi-step-form-purplish-blue border-multi-step-form-light-gray peer-checked:border-multi-step-form-purplish-blue flex-1 cursor-pointer rounded border p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-sm font-bold">Arcade</p>
                        <p className="text-multi-step-form-cool-gray text-xs font-medium">
                          $9/mo
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex justify-around px-4">
                ...
                <div class="my-8 flex w-full items-center justify-center">
                  <span class="mx-5 text-xs">Toggle me!</span>
