...
const validationSchemas = [
  Yup.object({
    ...
    phoneNumber: Yup.string()
      ...
      .matches(/^[0-9]+$/, "Only digits, no whitespaces.")
      .test("is-valid-phone-number", "Must be 8 digits", (value) => {
        ...
        <div className="min[800px]:px-6 relative -top-14 mx-4 flex flex-1 flex-col justify-between rounded-lg bg-white p-6 sm:top-0 sm:px-0 sm:pb-0 min-[800px]:mx-12">
          {!isSubmitted && activeStep === 0 && (
            <div>
              ...
              <div className="relative flex flex-col gap-3 text-multi-step-form-marine-blue sm:gap-6">
                <label
                  htmlFor="name"
