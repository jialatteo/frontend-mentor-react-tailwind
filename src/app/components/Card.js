import ImageCarouselWithPreview from "../ecommerce-product-page/ImageCarouselWithPreview";
...
export default function Card({
  ...
  return (
    <div className="m-4 w-[500px] overflow-hidden rounded-xl border text-xl">
      {/* <ImageCarouselWithPreview images={images} /> */}
      ...
      <div className="relative">
        ...
        <div className="group/card p-4">
          <a href={projectUrl} className="absolute inset-0 cursor-pointer" />
